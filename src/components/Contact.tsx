      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-gray-900 rounded-lg p-6 md:p-8">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">Send Message</h2>
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 md:px-4 py-2 md:py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm md:text-base"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 md:py-3 px-4 md:px-6 rounded-lg transition-colors text-sm md:text-base"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-gray-400">Gorakhpur, Uttar Pradesh, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-gray-400">ankit@example.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <h3 className="text-base md:text-lg font-semibold text-white">Response Time</h3>
                    <p className="text-sm md:text-base text-gray-400">Usually within 24 hours</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-900 rounded-lg p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <a 
                  href="#" 
                  className="flex items-center gap-2 md:gap-3 bg-gray-800 hover:bg-gray-700 p-3 md:p-4 rounded-lg transition-colors"
                >
                ...
                >
                  ...
                  <span className="text-white text-sm md:text-base">Twitter</span>
                </a>
                <a 
                  href="#" 
                  className="flex items-center gap-2 md:gap-3 bg-gray-800 hover:bg-gray-700 p-3 md:p-4 rounded-lg transition-colors"
